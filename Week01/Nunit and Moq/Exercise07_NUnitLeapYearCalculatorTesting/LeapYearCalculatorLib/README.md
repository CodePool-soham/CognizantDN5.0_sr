# Exercise07_NUnitLeapYearCalculatorTesting
...
```text
IsLeapYear_ValidAndInvalidYears_ReturnsExpectedResult
```
...
Parameterized testing allows multiple input values and expected outputs to be tested using a single test method.
...
The modification was made inside the leap year condition block.
