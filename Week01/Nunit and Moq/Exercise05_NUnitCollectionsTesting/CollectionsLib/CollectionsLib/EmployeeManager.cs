    ...
    public class EmployeeManager
    {
        ...
        static EmployeeManager()
        {
            employees = new List<Employee>
            {
                ...
                //for breaking the code uncomment below code and comment the above to check whether test cases can detect defects 
                //new Employee { EmpId=101, EmpName="John",DOJ=DateTime.Now.AddYears(-5),Salary=30000},
